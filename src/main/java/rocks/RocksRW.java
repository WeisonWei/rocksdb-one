...
public class RocksRW {
  private static final String dbPath = "./defaultCF";
  private static final String cfdbPath = "./CertainCF";

  public static void main(String[] args) throws RocksDBException {
    RocksRW t = new RocksRW();
  ...
  public void testCertainColumnFamily() throws RocksDBException {
    ...
    List<ColumnFamilyHandle> collect = cfHandles.stream().filter(x -> {
      /*try {
      ...
      //return (x.toString()).equals(cfName);
      return true;
    }).collect(Collectors.toList());

    ColumnFamilyHandle cfHandle = collect.get(0);
